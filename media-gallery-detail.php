...
<head>
   ...
   <title><?php echo $fixed_delivery_time['meta_title']; ?></title>
    ...
    <meta property="og:image" content="<?= SITE_URL; ?>upload/290126125406LOGO.png?v=1.5">
    <meta property="og:image:secure_url" content="<?= SITE_URL; ?>upload/290126125406LOGO.png?v=1.5">
    ...
    <meta name="twitter:image" content="<?= SITE_URL; ?>upload/290126125406LOGO.png?v=1.5">
            ...
            <div class="container">
                <div class="page-header__inner">
                    <ul class="thm-breadcrumb list-unstyled">
                        ...
                        <li><span>/</span></li>
                        <li> <?php custom_echo($fixed_delivery_time['name'], 30); ?></li>
                    </ul>
                    <h2>Media Gallery</h2>
                </div>
            </div>
...
<?php
$rawBlogName = $fixed_delivery_time['name'];
                    ...
                    <div class="col-xl-8 col-lg-7">
                        ...
                        <script>
                            function shareContent(event) {
                                ...
                                <p class="blog-details__text-2"><?php echo $fixed_delivery_time['des']; ?></p>
                            </div>
