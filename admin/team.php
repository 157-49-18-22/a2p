...
if (isset($_POST['addclient'])) {
    ...
    if (!$num) {
        ...
        $q = $pdo->prepare("INSERT into `team` values(:id,:name, :photo,:des,:des1, :fld_order, :actstat)");
        $q->execute(array(
            ':id' => $id,
...
if ($_GET['action'] == 'delete') {
    $sql_del = sqlfetch("delete from team where id='" . $_GET['id'] . "'");
                        ...
                        <div class="col-lg-12  mt-4" style="display: none;">
                            <div class="input-group input-group-merge">
                                ...
                                <div class="form-floating form-floating-outline">
                                    ...
                                    <label for="basic-addon11">Designation </label>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6  mt-4">
                            ...
                            foreach ($data as $menu) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="team.php?id=<?php echo $menu['id']; ?>&action=delete" onclick="return confirm('Are you sure you want to delete this item?');">
