...
if (isset($_POST['addclient'])) {
    ...
    if (!$num) {
        ...
        $q = $pdo->prepare("INSERT into `fixed_delivery_time` values(:id,:name, :photo,:des,:des1, :fld_order, :actstat)");
        $q->execute(array(
            ':id' => $id,
            ...
            <div class="row">
                ...
                <div class="col-lg-4  mt-3">
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            ...
                            <label for="basic-addon11">Add Time </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4  mt-3"   style="display: none;">
                    <div class="input-group input-group-merge">
                        <span class="input-group-text">@</span>
                        <div class="form-floating form-floating-outline">
                            <input type="text" class="form-control" name="des1" placeholder="Name" aria-label="Name" value="Fixed Delivery Time " readonly  />
                            <label for="basic-addon11">Fixed Time Delivery</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4  mt-3" style="display: none;">
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <?php
                            $abou_mission_sql = sqlfetch("SELECT * FROM standard_delivery_price where id='2' ");

                            if (count($abou_mission_sql)) {
                                foreach ($abou_mission_sql as $mission)

                            ?>
                                <input type="text" class="form-control" name="des" placeholder="Name" aria-label="Name" value="<?php echo $mission['name']; ?>" readonly />
                            <?php
                        }
