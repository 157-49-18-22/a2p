...
function about_form($pid = '0', $addr = '', $email = '', $phone = '', $des = '', $photo = '', $link = '', $facebook = '', $twitter = '', $youtube = '', $linkedin = '', $test_date = '', $class8 = '', $class9 = '', $class10 = '', $class11 = '', $all_tag = '',   $formname = 'addabout')
{ ?>
        ...
        <div class="form theme-form">
            ...
            <div class="col-lg-12  mt-5">
                    <div class="input-group input-group-merge">
                        <span class="input-group-text">@</span>
                        <div class="form-floating form-floating-outline">
                           <input type="text" class="form-control rrff" name="all_tag" placeholder="All Seo Tags" aria-label="Phone" value="<?php echo htmlspecialchars($all_tag); ?>" />
                        ...
                        <div class="card-body demo-vertical-spacing demo-only-element z4">
                            <div class="row">
                                ...
                                foreach ($productdata as $product) {
                                    extract($product);
                                    about_form($pid, $addr, $email, $phone, $des, $photo, $link, $facebook, $twitter, $youtube, $linkedin, $test_date, $class8, $class9, $class10, $class11,  $all_tag, $formname = 'editdone');
                                } ?>
                            </div>
                        </div>
                    </div>
