...
if (isset($_POST['addabout'])) {
    ...
    $q = $pdo->prepare("INSERT into `about` values(:id,:name,:des)");
    $q->execute(array(
        ':id' => $id,
        ':name' => $name,
        ':des' => $des
...
function about_form($pid = '0', $name = '',  $des = '', $photo = '', $formname = 'addabout')
{ ?>
                        ...
                        <div class="card-body demo-vertical-spacing demo-only-element z4">
                            <div class="row">
                                ...
                                foreach ($productdata as $product) {
                                    extract($product);
                                    about_form($pid, $name, $des, $photo, $formname = 'editdone');
                                } ?>
                            </div>
                        </div>
                    </div>
