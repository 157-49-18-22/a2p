...
if (isset($_POST['addclient'])) {
    ...
    $type = 1;
    $pdo = getPDOObject();
    // $sql = $pdo->query("SELECT * FROM `client_logo` where  name LIKE '$name'");
    // $num = $sql->rowCount();
    $num = 0;
    ...
    if (!$num) {
        ...
        $q = $pdo->prepare("INSERT into `client_logo` values(:id,:name, :photo,:des,:des1, :fld_order, :actstat)");
        $q->execute(array(
            ':id' => $id,
...
if ($_GET['action'] == 'delete') {
    $sql_del = sqlfetch("delete from client_logo where id='" . $_GET['id'] . "'");
    echo "<script>window.open('client_logo.php','_self')</script>";
}
...
if (isset($_POST['deleteall'])) {
    ...
    if (count($arr)) {
        ...
        $data = sqlfetch("select * from `client_logo` where id in ($str_rest_refs)");
        ...
        $pdo = getPDOObject();
        $q = $pdo->query("DELETE FROM `client_logo` WHERE id in ($str_rest_refs)");
        if ($q)
            $umessage = '<div class="alert alert-success" role="alert">
...
if (isset($_POST['editdone'])) {
    ...
    $pdo = getPDOObject();
    $q = $pdo->prepare("UPDATE `client_logo` SET 
...
{ ?>
    <form action="client_logo.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-6 mt-4">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <div class="form-floating form-floating-outline">
                                    ...
                                    <label for="basic-addon11">Project Photo</label>
                        ...
                        <div class="col-lg-6  mt-4 ">
                            <div class="input-group input-group-merge">
                                ...
                                <div class="form-floating form-floating-outline">
                                    ...
                                    <label for="basic-addon11">Project  Name </label>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4  mt-4 d-none">
                            <div class="input-group input-group-merge">
                                <span class="input-group-text">@</span>
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control" name="des" placeholder="Name" aria-label="Name" value="<?php echo $des; ?>" />
                                    <label for="basic-addon11">Designation / Destination</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6  mt-4">
...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Home/</span>client_logo Settings</h4>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body demo-vertical-spacing demo-only-element z4">
                            <div class="row">
                                <?php
                                $pid = $_GET['pid'];
                                $productdata = sqlfetch("SELECT * FROM `client_logo` where id='$pid' ");
                ...
                <div class="card-datatable dataTable_select text-nowrap table-responsive">
                    <table id="tableID" class="display dt-select-table table table-bordered" style="width:100%">
                        ...
                        <tbody>
                            <?php
                            $count = 1;
                            $data = sqlfetch("SELECT * FROM `client_logo`  order by fld_order");
                            foreach ($data as $menu) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="ajax-link" href="client_logo.php?&pid=<?php echo $menu['id']; ?>&edit=true">
                                    ...
                                    <td>
                                        ...
                                        <a href="client_logo.php?id=<?php echo $menu['id']; ?>&action=delete" onclick="return confirm('Are you sure you want to delete this item?');">
