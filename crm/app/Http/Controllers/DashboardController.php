...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $followups_today = FollowUp::whereDate('date_time', Carbon::now()->format('Y-m-d'))->paginate(4);
        $followups_upcoming = FollowUp::whereDate('date_time', '>', Carbon::now()->format('Y-m-d'))->paginate(4);
