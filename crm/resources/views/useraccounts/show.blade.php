...
@section('content_header')
    ...
    <div id="{{ $user->id }}" class="my-3">
        ...
        <a class="btn btn-primary text-uppercase float-right ml-2" href="{{ route('useraccounts.edit', ['id' => $user->id]) }}">
        ...
        <div class="row">
            <div class="col-6">
                <ul class="list-group">
					...
					<li class="list-group-item">
                        <span>Phone</span>:
                        <span class="pl-1 font-weight-bolder">{{ $user->phone }}</span>
                    </li>
					<li class="list-group-item">
                        <span>Address</span>:
                        <span class="pl-1 font-weight-bolder">{{ $user->address }}</span>
                    </li>
                    <li class="list-group-item">
                        <span>Photo</span>:
                        <span class="pl-1 font-weight-bolder">
                            @if (isset($user->photo_url))
                            <a href="{{ url('/storage/galeryImages').'/'. $user->photo_url }}" target="_blank" rel="noopener noreferrer">
					  ...
					  <li class="list-group-item">
                        ...
                        <span class="pl-1 font-weight-bolder">
                            ...
                            <a href="{{ url('/storage/galeryImages').'/'. $user->aadhar }}" target="_blank" rel="noopener noreferrer">
					 ...
					 <li class="list-group-item">
                        ...
                        <span class="pl-1 font-weight-bolder">
                            ...
                            <a href="{{ url('/storage/galeryImages').'/'. $user->pancard }}" target="_blank" rel="noopener noreferrer">
