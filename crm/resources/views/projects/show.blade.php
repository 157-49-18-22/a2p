        ...
        <div class="row">
            <div class="col-6">
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        <span>Location</span>:
                        <span class="pl-1 font-weight-bolder">{{ $project->location }}</span>
                    </li> 
					<li class="list-group-item">
                        <span>Address</span>:
                        <span class="pl-1 font-weight-bolder">{{ $project->address }}</span>
                    </li>
					<li class="list-group-item">
                        <span>Brochure</span>:
                        <span class="pl-1 font-weight-bolder">@if (isset($project->brochure))
                                <a href="{{ url('/storage/galeryImages').'/'. $project->brochure }}" target="_blank" rel="noopener noreferrer">
									{{$project->brochure}}
                                </a>
                            @else
