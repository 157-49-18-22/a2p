            ...
            <table class="table" id="example">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th class="text-uppercase" scope="col">Client name</th>
                        <th class="text-uppercase" scope="col">Contact No</th>
                        <th class="text-uppercase" scope="col">Agreement Value</th>
                        <th class="text-uppercase" scope="col">Booking Amount</th>
                        <th class="text-uppercase" scope="col">Closed by</th>
                    </tr>
                </thead>
                <tbody>
				<?php 
				...
				<?php 
				 $i++;?>
                    <tr>
                        ...
                        <td>{{$d['name']}}</td>
                        <td>{{$d['contact_no']}}</td>
						<td><a href="{{ route('enquiries.index', ['user_id' => $d['user_id'],'status'=>'closed' ]) }}">{{$d['closed_by']}}</a></td>
                        <td>{{$d['agreement_value']}}</td>
