...
@section('title', 'Leads Transfer Reports')

@section('content_header')
    <h1>Leads Transfer Reports</h1>
@stop
            ...
            <table class="table" id="example">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th class="text-uppercase" scope="col">Lead Id</th>
                        <th class="text-uppercase" scope="col">Previous User</th>
                        <th class="text-uppercase" scope="col">Current User</th>
                        <th class="text-uppercase" scope="col">Assigned On</th>
                    </tr>
                </thead>
                <tbody>
				<?php 
