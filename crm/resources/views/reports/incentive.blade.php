            ...
            <table class="table" id="example">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th class="text-uppercase" scope="col">Project Name</th>
                        <th class="text-uppercase" scope="col">User </th>
                        <th class="text-uppercase" scope="col">Incentive Percentage</th>
                        <th class="text-uppercase" scope="col">Incentive Amount</th>
                    </tr>
                </thead>
                <tbody>
				<?php 
				...
				<?php 
				 $i++;?>
                    <tr>
                        ...
                        <td>{{$d['lead_id']}}</td>
                        <td>{{$d['user_name']}}</td>
                        <td>{{$d['incentive_percentage']}}</td>
                        <td>{{$d['incentive_amount']}}</td>
                    </tr>
