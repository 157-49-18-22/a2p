...
// brokerage amount = % brokerage of booking amount
document.querySelector('#incentive_employee_percent').addEventListener('keyup', (e) => {
    let agreement_value = document.querySelector('#brokerage_amount').value;
    let brokerage_amount = document.querySelector('#incentive_employee_amount');
    brokerage_amount.value = e.currentTarget.value / 100 * agreement_value;
});

document.querySelector('#brokerage_amount').addEventListener('keyup', (e) => {
    let brokerage_percent = document.querySelector('#incentive_employee_percent').value;
    let brokerage_amount = document.querySelector('#incentive_employee_amount');
    brokerage_amount.value = brokerage_percent / 100 * e.currentTarget.value;
});
