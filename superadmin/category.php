...
if (isset($_POST['addclient'])) {
    ...
    if (!$num) {
        ...
        $q = $pdo->prepare("INSERT into `category` values(:id,:name, :photo,:des,:des1, :meta_title, :meta_keyword, :meta_description, :fld_order, :actstat)");
        $q->execute(array(
            ':id' => $id,
            ':name' => $name,
            ':photo' => $Filename,
...
if ($_GET['action'] == 'delete') {
    $sql_del = sqlfetch("delete from category where id='" . $_GET['id'] . "'");
...
if (isset($_POST['editdone'])) {
    ...
    name=?, photo=?, des=?, des1=?, meta_title=?, meta_keyword=?, meta_description=?, fld_order=?, actstat=?
    WHERE id=?");
                        ...
                        <div class="col-lg-12  mt-4">
                            <div class="input-group input-group-merge">
                                ...
                                <div class="form-floating form-floating-outline">
                                    ...
                                    <label for="basic-addon11">Short Description </label>
                                </div>
                            </div>
                        </div>
                            ...
                            foreach ($data as $menu) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="category.php?id=<?php echo $menu['id']; ?>&action=delete" onclick="return confirm('Are you sure you want to delete this item?');">
