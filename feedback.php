            ...
            <div class="col-xl-12">
                <div class="testimonial-two__inner">
                    <div class="owl-carousel owl-theme thm-owl__carousel testimonial-one__carousel"
                        ...
                        <?php $result = sqlfetch("select * from testimonial ");
                        if (count($result)) {
                        ...
                        ?>
                                ...
                                <div class="testimonial-one__single">
                                    ...
                                    <p class="testimonial-one__text-2"><?php echo $testimonial['des']; ?></p>
                                    <div class="testimonial-one__client-info">
                                        <div class="testimonial-one__img">
                                            <img src="upload/<?php echo $testimonial['photo']; ?>" alt="">
                                        </div>
                                        <div class="testimonial-one__client-content">
                                            <h4 class="testimonial-one__client-name"><?php echo $testimonial['name']; ?></h4>
                                            <p class="testimonial-one__client-title"><?php echo $testimonial['des1']; ?></p>
                                        </div>
                                    </div>
                                </div>
                        <?php }
