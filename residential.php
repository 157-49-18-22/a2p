...
.project-three__img {
    height: 300px !important; /* Balanced height for project banners */
    width: 100% !important;
...
.project-three__img img {
    ...
    object-fit: cover !important; /* NO MORE WHITE GAPS */
}
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="project-three__single">
                            <div class="project-three__img-box">
                                <div class="project-three__img" style="background: url('<?php echo $finalImg; ?>') center/cover no-repeat;">
                                    <img src="<?php echo $finalImg; ?>" alt="<?php echo htmlspecialchars($client_logo['name']); ?>" style="object-fit: contain; backdrop-filter: blur(8px); background: rgba(0,0,0,0.2); width: 100%; height: 100%;">
                                    <div class="project-three__arrow">
                                        <a href="#"><i class="fa fa-angle-right"></i></a>
                                    </div>
                                    <div class="project-three__content">
                                        <h3 class="project-three__title"><a href="#"><?php echo $client_logo['name']; ?></a></h3>
